...
function(dotmusicFactory){
    ...
    dotmusic.setParam("play", 1);    //or// dotmusic.setParamNorm("play", 0.500);
    dotmusic.setParam("Frequency", 5);    //or// dotmusic.setParamNorm("Frequency", 0.500);
    dotmusic.setParam("Release Time", 0.2);    //or// dotmusic.setParamNorm("Release Time", 0.067);
    dotmusic.setParam("Key", 0);    //or// dotmusic.setParamNorm("Key", 0.000);
    dotmusic.setParam("Gain", 0.9);    //or// dotmusic.setParamNorm("Gain", 0.900);
